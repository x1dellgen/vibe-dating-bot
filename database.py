...
async def get_next_candidate(user_id):
    ...
    user_gender = info['gender']       # "Парень" / "Девушка"
    user_pref = info['preference']     # "Парней" / "Девушек" / "Всех"
    user_city = info['city']
    user_scope = info['search_scope']  # "city" / "all"
    ...
    async with aiosqlite.connect(DB_NAME) as conn:
        ...
        # Взаимный фильтр (ищет ли та анкета текущего пользователя)
        pref_clause = ""
